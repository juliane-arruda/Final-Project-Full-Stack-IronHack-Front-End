...
const Contact = () => (
  <div className="container-fluid test-0">
    <div className="container d-inline-flex flex-column flex-md-row align-items-center justify-content-around row mt-5 test-1">
      {/* <img src="/images/fundo.png" alt="background"/> */}
      <div className="test-2 col-12 col-md-6 col-lg-4">
        <h4>Contato</h4>
        <p>Telefone: (21) 2233-5950</p>
        <p>E-mail: icatyoupet@gmail.com</p>
        <p>Alameda Jaú, 1301 - Jardim Paulista,<br /> São Paulo - SP, 01420-001</p>
      </div>
      <div className="test-3 my-2 col-12 col-md-6 col-lg-4">
        <h4>SIGA-NOS</h4>
      ...
      <div className="test-4 col-12 col-md-6 col-lg-4">
