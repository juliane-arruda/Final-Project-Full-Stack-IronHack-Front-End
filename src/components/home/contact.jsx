...
const Contact = () => (
  <div id="contact" className="container-fluid">
    <div className="container d-inline-flex flex-column flex-md-row align-items-center justify-content-around row mt-5">
      ...
      <div className="col-12 col-md-6 col-lg-4">
        <iframe className="home-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6255.526157490973!2d-46.660939413709485!3d-23.561946062049994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59468d48985b%3A0x694f27fed85d9b0c!2sIronhack%20S%C3%A3o%20Paulo!5e0!3m2!1spt-BR!2sbr!4v1580927864945!5m2!1spt-BR!2sbr" frameborder={"0"} border={"0"} allowfullscreen={""}></iframe>
      </div>
    </div>
  </div>
);
